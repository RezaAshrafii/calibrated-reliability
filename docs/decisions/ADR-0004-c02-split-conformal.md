...
The preregistered C02 configuration is frozen to cap 125, seeds `13,37,73,101,137`, alpha `0.10` and `0.05`, temporal windows `5,10,20`, a zero variance threshold, and cut-point constraints of at least 30 cycles and 40–90% of the complete trajectory. A C02 runner rejects deviations; sensitivity conditions belong to their separately registered experiments.
